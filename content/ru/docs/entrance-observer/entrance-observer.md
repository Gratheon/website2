...
Обзор уровня продукта см. в [Entrance Observer](../../products/entrance_observer/entrance_observer.md). Собранные метрики подключаются к [хранилищу телеметрии Hive](../../products/web_app/pro-tier/hive-telemetry-storage.md) и [аналитике временных рядов](../../products/web_app/pro-tier/timeseries-data-analytics.md).
