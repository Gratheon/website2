...
- **TelemetryChart**: встроенный компонент графиков для расширенной аналитики.
...
- **графики web-app**: встроенный интерфейс визуализации и аналитики.
...
- **Нагрузка графиков**: сложные экраны аналитики в web-app могут генерировать несколько telemetry-запросов одновременно.
...
- Отдельная аутентификация для аналитики не нужна: графики работают внутри авторизованной сессии web-app.
...
- [REST API Ссылка](../../API/rest/index.md)
...
- **Telemetry chart components**: поддерживаются в кодовой базе web-app.
...
- Запросы графиков из web-app должны проходить через `graphql-router`, чтобы доступ к telemetry оставался за авторизованной API-границей.
