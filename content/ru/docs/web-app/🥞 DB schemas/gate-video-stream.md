[gate-video-stream](https://github.com/Gratheon/gate-video-stream) хранит простую информацию о видео, транслируемых с помощью [entrance-observer](../../entrance-observer/entrance-observer.md)
