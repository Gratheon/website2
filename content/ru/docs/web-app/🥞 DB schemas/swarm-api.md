...
---
[swarm-api](https://github.com/gratheon/swarm-api) занимается простым хранением основных объектов приложения.

Обратите внимание, что информация о сторонах кадра расширяется на image-splitter.
