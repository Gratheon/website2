...
layout: research
hideToc: true
title: "О прогнозировании заражений варроатозом медоносных пчёл с помощью акустического мониторинга"
description: "Исследование IEEE Sensors Journal, использующее традиционные и модуляционные спектрограммные дескрипторы с машинным обучением для прогнозирования уровня заражения варроатозом по аудиозаписям из улья."
year: '2026'
authors:
- Mahsa Abdollahi
- Yi Zhu
