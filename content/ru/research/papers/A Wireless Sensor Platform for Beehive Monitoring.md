...
layout: research
hideToc: true
title: "Беспроводная сенсорная платформа для мониторинга ульев"
description: "Беспроводная плата для мониторинга температуры улья, относительной влажности и CO₂, подтверждённая полевыми испытаниями, включая измерения реакций колонии на механические возмущения."
year: '2026'
authors:
- Sudipta Das Gupta
- Jeffrey S. Erickson
