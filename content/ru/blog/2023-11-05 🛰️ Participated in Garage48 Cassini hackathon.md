---
title: "🛰️ Участвовали в хакатоне Garage48 Cassini"
---

Мы участвовали в общеевропейском хакатоне по обработке спутниковых данных, локально организованном Garage48.

Наши основные цели:
- networking для расширения команды
- повышение узнаваемости проекта как маркетинг
- разработка продуктовых функций с геоданными для пасек
