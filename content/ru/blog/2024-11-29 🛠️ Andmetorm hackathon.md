---
title: "🛠️ Хакатон Andmetorm"
---

Мы участвовали в хакатоне **Data Storm**, посвящённом использованию открытых государственных данных Эстонии, особенно в областях environment, weather, hydrology и alerts. Наш проект решал проблему **штормового ветра, который опрокидывает ульи**, и предлагал решение в виде **weather alerts**.

### Наш фокус

- 🗃️ Опрокидывание ульев штормовым ветром
- 📡 Weather alerts
...
Общее фото участников и менторов от Tiit Tamme / Garage48:
