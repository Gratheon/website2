---
title: "Заявка Prototron Top 40"
---

Мы во второй раз участвовали в программе финансирования Prototron и подали заявку на рассмотрение.
Ниже — детали нашей заявки для Prototron Top 40.
Мы делимся этой информацией для прозрачности нашего funding journey и чтобы показать, над какими проектами мы работаем, потому что прозрачность — одна из [наших core values](../about/company/values/values.md).
