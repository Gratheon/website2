---
title: "🛰️ Спутниковый вид пасеки"
---

См. также [Оптимизация опыления с рекомендациями по размещению ульев](pollination-optimization-with-hive-placement-recommendation.md)

![](../../../../about/img/Screenshot%202023-11-02%20at%2012.09.17.png)
[beehero.io](http://beehero.io) оптимизация размещения ульев

![](../../../../about/img/stories-3.jpg.webp)
классификация полей eosdata

## Ссылки и потенциальные источники данных

- EOS Data - типы культур [https://eos.com/products/crop-monitoring/custom-solutions/crops-classification/](https://eos.com/products/crop-monitoring/custom-solutions/crops-classification/)
...
- API пыльцы 1кмx1км через Google [https://mapsplatform.google.com/maps-products/pollen/](https://mapsplatform.google.com/maps-products/pollen/) [https://console.cloud.google.com/google/maps-apis/api-list?project=gratheon](https://console.cloud.google.com/google/maps-apis/api-list?project=gratheon)
...
- данные о загрязнении в Эстонии, по городам [http://airviro.klab.ee/en](http://airviro.klab.ee/en) [https://hub.eaaci.org/patients_resources/worldwide-pollen-map/](https://hub.eaaci.org/patients_resources/worldwide-pollen-map/)
...
## Связанные научные работы для вдохновения
