...
layout: research
hideToc: true
title: Spectrogram-Based Deep Learning Models for Acoustic Identification of Honey Bees in Complex Environmental Noises
description: An open-access comparison of CNN backbones for recognizing honeybee buzzing in noisy field recordings, with MobileNetV2 providing the strongest generalization.
year: '2026'
authors:
- Muhammad Anus Khan
- Bilal Hassan Khan
