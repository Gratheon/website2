...
layout: research
hideToc: true
title: Detection and classification of honeybee castes using thermal imaging and deep learning
description: Open-access study classifying queens, workers, and drones from more than 500 thermal images using handcrafted thermal features and neural networks.
year: '2026'
authors:
- Alireza Derakhshi
- Hekmat Rabbani
