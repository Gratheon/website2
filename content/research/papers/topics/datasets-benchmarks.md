...
<section class="research-year-filter" aria-labelledby="research-year-filter-title">
  ...
  <div class="research-year-filter__shell">
    <div class="research-year-timeline" role="tablist" aria-label="Filter publications by year">
      ...
      <label class="research-year-tab">
        <input type="radio" class="research-year-filter__input" name="datasets-benchmarks-year-filter" value="2019">
        <span class="research-year-tab__label">2019</span>
        <span class="research-year-tab__count">2</span>
      </label>
      <span class="research-year-tab__arrow" aria-hidden="true">›</span>
      <label class="research-year-tab">
        <input type="radio" class="research-year-filter__input" name="datasets-benchmarks-year-filter" value="2020">
        <span class="research-year-tab__label">2020</span>
        <span class="research-year-tab__count">1</span>
      </label>
      <span class="research-year-tab__arrow" aria-hidden="true">›</span>
      <label class="research-year-tab">
        <input type="radio" class="research-year-filter__input" name="datasets-benchmarks-year-filter" value="2021">
        <span class="research-year-tab__label">2021</span>
        <span class="research-year-tab__count">1</span>
      </label>
      <span class="research-year-tab__arrow" aria-hidden="true">›</span>
      <label class="research-year-tab">
        <input type="radio" class="research-year-filter__input" name="datasets-benchmarks-year-filter" value="2022">
        <span class="research-year-tab__label">2022</span>
        <span class="research-year-tab__count">1</span>
      </label>
      <span class="research-year-tab__arrow" aria-hidden="true">›</span>
      <label class="research-year-tab">
        <input type="radio" class="research-year-filter__input" name="datasets-benchmarks-year-filter" value="2023">
      ...
      <span class="research-year-tab__arrow" aria-hidden="true">›</span>
      <label class="research-year-tab">
        <input type="radio" class="research-year-filter__input" name="datasets-benchmarks-year-filter" value="2025">
