...
**Authors:** Daniela Scutaru, et al.  
**PDF:** [An AI-Based Digital Scanner for Varroa destructor Detection in Beekeeping.pdf](pdfs/An AI-Based Digital Scanner for Varroa destructor Detection in Beekeeping.pdf)
...
## Notes
- Topic: Varroa mite fall detection on sticky boards.
- Strong relevance to sticky board image analysis for Mite fall.
