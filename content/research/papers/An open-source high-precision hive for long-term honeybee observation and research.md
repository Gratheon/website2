...
layout: research
hideToc: true
title: An open-source high-precision hive for long-term honeybee observation and research
description: A standardized open-hardware observation hive designed to make long-term computer-vision experiments and honeybee tracking more reproducible across research sites.
year: '2026'
authors:
- Jiří Ulrich
- Martin Stefanec
