...
description: "Multisensor platform measuring hive weight, sound, temperature, humidity, and CO₂ in real time, with sensor fusion to detect swarming, theft, honey gathering, and food shortage events."
year: "2020"
orgs:
...
[PDF](pdfs/A Smart Sensor-Based Measurement System for Advanced Bee Hive Monitoring.pdf)

<object data={require('./pdfs/A Smart Sensor-Based Measurement System for Advanced Bee Hive Monitoring.pdf').default} type="application/pdf" width="100%" height="800"></object>

## External links

- DOI: https://doi.org/10.3390/s20092726
- [Full text (MDPI Sensors)](https://www.mdpi.com/1424-8220/20/9/2726)
