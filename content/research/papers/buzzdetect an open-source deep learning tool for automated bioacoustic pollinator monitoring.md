...
layout: research
hideToc: true
title: 'buzzdetect: an open-source deep learning tool for automated bioacoustic pollinator monitoring'
description: Open-source deep-learning pipeline, reproducible data, and models for detecting insect flight buzzes in long-duration field audio recordings.
year: '2025'
authors:
- Luke E. Hearon
- Lillian H. P. Johnson
