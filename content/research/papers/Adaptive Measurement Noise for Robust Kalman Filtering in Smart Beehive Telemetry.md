...
description: Honeybee colony monitoring generates multimodal, non-stationary telemetry streams that require reliable recursive state estimation with well-calibrated uncertainty for digital apiculture. Although Kal...
year: '2026'
authors:
- H.A.A.U. Ranasinghe
- Navod Neranjan
