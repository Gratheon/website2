...
description: Teaching robotics with the robot operating system (ROS) is valuable for instating good programming practices but requires significant setup steps from the learner.
year: '2024'
orgs:
- "\U0001F1EA\U0001F1EA University of Tartu"
topics:
- robotics
productAreas:
- robotics
paperType: journal
pdf: "/assets/research/papers/pdfs/Open_remote_web_lab_for_learning_robotics_and_ROS_.pdf"
doi: 10.1109/TLT.2024.3381858
