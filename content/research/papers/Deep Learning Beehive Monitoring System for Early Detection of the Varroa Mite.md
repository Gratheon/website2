...
**PDF:** [Deep Learning Beehive Monitoring System for Early Detection of the Varroa Mite.pdf](pdfs/Deep Learning Beehive Monitoring System for Early Detection of the Varroa Mite.pdf)
...
## Notes
- Topic: Varroa mite detection using internal hive camera and deep learning.
- Very actionable for Gratheon: End-node camera inside brood box, embedded deep learning.
