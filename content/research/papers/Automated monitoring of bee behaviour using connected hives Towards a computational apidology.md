...
layout: research
hideToc: true
title: 'Automated monitoring of bee behaviour using connected hives: Towards a computational apidology'
description: A major difficulty in studying the behaviour of social insects, such as bees, is to collect quantitative data on large numbers of individuals and over long periods of time, in sometimes dark and not easily accessible nests.
year: '2019'
authors:
- Paul Marchal
orgs:
- "\U0001F1EB\U0001F1F7 CNRS Research Center on Animal Cognition"
- "\U0001F1EB\U0001F1F7 Université Toulouse III - Paul Sabatier"
topics:
- iot-sensors
- bee-behaviour
- reviews-surveys
