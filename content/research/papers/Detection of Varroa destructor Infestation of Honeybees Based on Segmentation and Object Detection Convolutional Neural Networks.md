...
[PDF](pdfs/Detection of Varroa destructor Infestation of Honeybees Based on Segmentation and Object Detection Convolutional Neural Networks.pdf)

<object data={require('./pdfs/Detection of Varroa destructor Infestation of Honeybees Based on Segmentation and Object Detection Convolutional Neural Networks.pdf').default} type="application/pdf" width="100%" height="800"></object>

## External links

- DOI: https://doi.org/10.3390/agriengineering5040102
- [Full text (MDPI AgriEngineering)](https://www.mdpi.com/2624-7402/5/4/102)
