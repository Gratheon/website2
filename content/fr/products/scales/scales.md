...
### Problèmes ciblés
Parmi les problèmes apicoles, ce produit aide particulièrement à suivre :
- l’essaimage ;
- la famine de la colonie ;
- le pillage ;
- les dégâts d’ours sur les ruches et colonies ;
- les ruches renversées par les tempêtes ;
- les emplacements éloignés.

## Public cible
- Apiculteurs amateurs
- Apiculteurs professionnels ou exploitations plus grandes
- Apiculteurs urbains
