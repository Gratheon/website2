...
flowchart TB
    ...
    click HX711 "./wiring-diagrams/full-system-wiring/" "See complete lab wiring"
    click LC "./wiring-diagrams/full-system-wiring/" "See complete lab wiring"

    subgraph TEMP["Temperature chain"]
        DS18B20[DS18B20 waterproof probe]
        PULLUP[4.7 kOhm pull-up]
    end
    click DS18B20 "./wiring-diagrams/full-system-wiring/" "See complete lab wiring"
