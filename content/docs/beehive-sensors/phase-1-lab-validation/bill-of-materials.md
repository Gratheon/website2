...
| Required | Weight ADC | HX711 load-cell amplifier breakout | 1 | €1-8 | [SparkFun HX711 breakout](https://www.sparkfun.com/products/13879), [Adafruit HX711 breakout](https://www.adafruit.com/product/5974), [Generic HX711 on AliExpress](../components/HX711-bar.md) | SparkFun/Adafruit are easier for docs; AliExpress is cheaper. |
...
| Required | Waterproof temperature sensor | DS18B20 probe | 1 | €2-10 | [Existing AliExpress DS18B20](../components/DS18B20.md), [Adafruit waterproof DS18B20](https://www.adafruit.com/product/381), [Amazon DS18B20 search](https://www.amazon.de/s?k=DS18B20+waterproof) | Use waterproof version even in lab so field wiring is similar. |
...
| Optional | Pull-up resistor kit | 4.7 kOhm resistor for DS18B20 data line | 1 | <€1 | [Amazon resistor kit search](https://www.amazon.de/s?k=resistor+kit), local electronics shop | Needed for reliable 1-Wire communication if not built into probe board. |
| Optional | Bench display | LCD1602 I2C display | 1 | €2-6 | [Existing LCD1602 listing](../components/display.md), [Amazon LCD1602 I2C search](https://www.amazon.de/s?k=LCD1602+I2C) | Debug only; do not include in outdoor MVP by default. |

## Connection accessories

These small items are worth buying early because they reduce false debugging work:

- 2-pin and 3-pin screw-terminal blocks for DS18B20 and power.
- 4-pin screw-terminal block for load-cell wires.
- Heat-shrink labels or masking-tape flags for `E+`, `E-`, `A+`, `A-`, `DATA`, `3V3`, and `GND`.
- A known calibration weight. A dumbbell or water container is acceptable if its mass is measured once on a trusted scale.
