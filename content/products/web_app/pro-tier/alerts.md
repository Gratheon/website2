...
- Under `Alerts`
    - sets an alert channel from the select `Alert me via: [email]`
        ...
        - [Webhooks integration](../💡%20future%20ideas/pro%20tier%20ideas%20💡/🪝%20Webhooks%20integration.md)
- Under alert types, he can choose (as checkbox) which alert types he wants to receive (the list should be quite long)
    - swarming risk - [Frame side queen cup detection](../hobbyist-tier/🐝%20Queen%20cup%20detection.md)
    ...
    - queen is failing to lay eggs - [Frame analysis - spotty brood pattern detection](../💡%20future%20ideas/pro%20tier%20ideas%20💡/🔔%20Frame%20analysis%20-%20spotty%20brood%20pattern%20detection.md)
    - drone cell ratio is too high - [Drone brood detection](../💡%20future%20ideas/🐝%20Drone%20brood%20detection.md)
