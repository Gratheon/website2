...
3. If you are a [Backyard beekeepers](https://www.notion.so/Backyard-beekeepers-3f32d134fa11467aad7f5015288a2efe?pvs=21) and you are worried about [**Infestation of Varroa mite**](../🦀%20Varroa%20infestation%20management.md), you may want to know who are your neighbour beekeepers. And also share your position and varroa infestation levels.
...
- In apiary creation & edit view, add new privacy checkboxes
    ...
    - If checked, display apiary location for other web-app users
        ...
        - apiary icon of others should also show varroa infestation metric, see [Varroa infestation management](../🦀%20Varroa%20infestation%20management.md)
- In apiary edit view, add button `Get directions link`
    ...
    - on opening a apiary URL by anonymous user, should show
        ...
        - hint about [Hive ownership transfer](../../free-tier/hive_ownership_transfer.md) ability
        - map
            - circle around apiary
- In apiary edit view, add button `Generate pesticide exposure notice`
    - allow user to select affected hives
        - select videos from [Video streaming playback](../../flexible-tier/video_playback.md) as proof
    - Generate a URL for the public page
    - On page show
        - hives affected
            - selected videos from [Video streaming playback](../../flexible-tier/video_playback.md)