...
- Open a specific frame, click "upload frame photo" with bees and comb cells on it. See [frame side management](free-tier/frame-side-management.md) and [inspection management](hobbyist-tier/inspection-management.md).
...
- Power on IoT sensors device, follow [beehive sensors docs](../../docs/beehive-sensors/beehive-sensors.md) to connect it to WiFi and send data
...
- Setup [Entrance Observer](../entrance_observer/entrance_observer.md) camera to stream video
...
- [Hive bottom board varroa counting](starter-tier/hive-bottom-varroa-count.md) will provide mite counts and treatment recommendations
