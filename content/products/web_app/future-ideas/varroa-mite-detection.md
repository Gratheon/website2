...
- Prepare the data. For this we need to cut regions from the original frame where we detect bees - see [Worker bee detection](../hobbyist-tier/worker-bee-detection.md)
