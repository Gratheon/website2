...
To help beekeepers do [Varroa Treatment diary](../../free-tier/varroa-treatment-diary.md) and plan their events without the need of using our app all the time, we should integrate popular google calendar to synchronize events
...
- When user **adds** a new event in [Varroa Treatment diary](../../free-tier/varroa-treatment-diary.md) or [Calendar view (of events, treatments, alerts)](calendar-view.md), we should synchronize this event one way → google calendar
