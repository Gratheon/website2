...
Tootetaseme ülevaate saamiseks vaadake jaotist [Entrance Observer](../../about/products/entrance_observer/entrance_observer.md). Jäädvustatud mõõdikud loovad ühenduse [taru telemeetriasalvestusega](/about/products/web_app/pro-tier/hive-telemetry-storage/) ja [aegridade analüüsiga](/about/products/web_app/pro-tier/timeseries-data-analytics/).
