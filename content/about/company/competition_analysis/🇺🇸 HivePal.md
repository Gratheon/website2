...
priority: 4
threat_level: MEDIUM
target_market: Hobbyist and semi-professional beekeepers who want free/open-source apiary management
location: USA / global open source
pricing: Free; self-hosted and hosted options advertised as free
status: active
description: Free, open-source beekeeping management app with voice-first AI inspection notes, apiary management, queen tracking and harvest workflows.
---
...
![Hive Pal apiary dashboard grid](img/hivepal-1.png)

![Hive Pal hive overview](img/hivepal-2.png)

![Hive Pal analytics screen](img/hivepal-3.png)
